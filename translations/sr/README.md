...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T21:21:06+00:00",
...
## Курс који вас учи свему што треба да знате за креирање AI агената
...
Овај курс садржи лекције које покривају основе креирања AI агената. Свака лекција покрива посебну тему, па можете почети где год желите!
...
| Управљање меморијом агента                   | [Линк](./13-agent-memory/README.md)     |                                                            |                                                                                        |
