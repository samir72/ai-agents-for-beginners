...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-02T13:50:53+00:00",
...
3. **Сохранение в базе знаний**: Сохранение извлеченной информации, часто в векторной базе данных, чтобы ее можно было использовать позже.
