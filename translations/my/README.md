...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-02T06:01:24+00:00",
...
## AI အေးဂျင့်များတည်ဆောက်ရန်အတွက် လိုအပ်သောအရာများကို သင်ကြားပေးသည့် သင်တန်း
...
**အခြားဘာသာစကားများကို ပံ့ပိုးလိုပါက [ဒီမှာ](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md) ရှိသောစာရင်းကို ကြည့်ပါ**
...
ဒီသင်တန်းမှာ AI အေးဂျင့်များတည်ဆောက်ခြင်းအခြေခံကို ဖော်ပြထားတဲ့ သင်ခန်းစာများပါဝင်ပါတယ်။ သင်ခန်းစာတိုင်းမှာ ကိုယ်ပိုင်အကြောင်းအရာကို ဖော်ပြထားပြီး သင်စိတ်ဝင်စားရာနေရာက စတင်နိုင်ပါတယ်။

ဒီသင်တန်းမှာ ဘာသာစကားများစွာကို ပံ့ပိုးထားပါတယ်။ [ဒီမှာ](../..) သွားပြီး ရနိုင်သောဘာသာစကားများကို ကြည့်ပါ။

Generative AI မော်ဒယ်များကို ပထမဆုံးအကြိမ် အသုံးပြုဖို့ စဉ်းစားနေပါက [Generative AI For Beginners](https://aka.ms/genai-beginners) သင်တန်းကို ကြည့်ပါ။ ဒီသင်တန်းမှာ GenAI ကို အသုံးပြုပြီး တည်ဆောက်ခြင်းအပေါ် သင်ခန်းစာ 21 ခုပါဝင်ပါတယ်။
...
AI အေးဂျင့်များတည်ဆောက်ရာမှာ အခက်အခဲရှိပါက သို့မဟုတ် မေးခွန်းများရှိပါက [Azure AI Foundry Community Discord](https://aka.ms/ai-agents/discord) မှာရှိတဲ့ Discord Channel ကို ဝင်ရောက်ပါ။

### လိုအပ်သောအရာများ

ဒီသင်တန်းမှာ code နမူနာများပါဝင်ပြီး code_samples folder မှာ ရှိပါတယ်။ [ဒီ repo ကို fork](https://github.com/microsoft/ai-agents-for-beginners/fork) လုပ်ပြီး ကိုယ်ပိုင် copy တစ်ခုကို ဖန်တီးနိုင်ပါတယ်။

ဒီလေ့ကျင့်ခန်းများမှာ Azure AI Foundry နှင့် GitHub Model Catalogs ကို အသုံးပြုပြီး Language Models တွေကို အပြန်အလှန်လုပ်ဆောင်ပါတယ်-
...
ဒီသင်တန်းမှာ Microsoft မှ AI အေးဂျင့် frameworks နှင့် services အောက်ပါအရာများကို အသုံးပြုထားပါတယ်-
...
ဒီသင်တန်းအတွက် code ကို run လုပ်ရန် အချက်အလက်များကို [Course Setup](./00-course-setup/README.md) မှာ ကြည့်ပါ။

## 🙏 အကူအညီပေးလိုပါသလား?

အကြံပြုချက်များရှိပါသလား သို့မဟုတ် စာလုံးပေါင်းအမှားများ သို့မဟုတ် code အမှားများကို ရှာဖွေတွေ့ရှိပါသလား? [Issue တစ်ခုကို တင်ပါ](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) သို့မဟုတ် [Pull request တစ်ခုကို ဖန်တီးပါ](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)

## 📂 သင်ခန်းစာတစ်ခုစီမှာ ပါဝင်သည်

- README မှာ ရေးသားထားတဲ့ သင်ခန်းစာနှင့် အတိုချုံးဗီဒီယို
- Azure AI Foundry နှင့် Github Models (အခမဲ့) ကို ပံ့ပိုးတဲ့ Python code နမူနာများ
- သင်ယူမှုကို ဆက်လက်လုပ်ဆောင်ရန် အပိုအရင်းအမြစ်များကို ချိတ်ဆက်ထားသည်
...
ဤပရောဂျက်သည် ပံ့ပိုးမှုများနှင့် အကြံပြုချက်များကို ကြိုဆိုပါသည်။ ပံ့ပိုးမှုအများစုသည် Contributor License Agreement (CLA) ကို သဘောတူရန် လိုအပ်ပါသည်။ သင့်ပံ့ပိုးမှုကို အသုံးပြုရန် ကျွန်ုပ်တို့အား အခွင့်အရေးပေးရန် သင့်တွင် အခွင့်အရေးရှိကြောင်း သက်သေပြရန် CLA လိုအပ်ပါသည်။ အသေးစိတ်အချက်အလက်များအတွက် <https://cla.opensource.microsoft.com> ကို ကြည့်ရှုပါ။

သင် Pull Request တင်သည့်အခါ CLA bot သည် သင့်အား CLA ပေးရန် လိုအပ်မလိုအပ်ကြောင်း အလိုအလျောက် ဆုံးဖြတ်ပြီး PR ကို သင့်တော်စွာ အလှဆင်ပါမည် (ဥပမာ - status check, comment)။ Bot မှ ပေးထားသော အညွှန်းများကို လိုက်နာပါ။ CLA ကို သင်တစ်ကြိမ်သာ လိုအပ်မည်ဖြစ်ပြီး CLA အသုံးပြုသည့် repo အားလုံးတွင် သက်တမ်းရှိပါသည်။

ဤပရောဂျက်သည် [Microsoft Open Source Code of Conduct](https://opensource.microsoft.com/codeofconduct/) ကို လက်ခံထားပါသည်။ 
ပိုမိုသိရှိလိုပါက [Code of Conduct FAQ](https://opensource.microsoft.com/codeofconduct/faq/) ကို ကြည့်ရှုပါ။ သို့မဟုတ် [opencode@microsoft.com](mailto:opencode@microsoft.com) သို့ အပိုဆောင်းမေးခွန်းများ သို့မဟုတ် မှတ်ချက်များ ပေးပို့ပါ။
...
Microsoft အမှတ်တံဆိပ်များ သို့မဟုတ် လိုဂိုများကို ပြင်ဆင်ထားသော ဤပရောဂျက်တွင် အသုံးပြုခြင်းသည် Microsoft မှ ပံ့ပိုးမှုရှိကြောင်း သံသယဖြစ်စေမည်မဟုတ်ပါ။ တတိယအဖွဲ့အစည်းများ၏ အမှတ်တံဆိပ်များ သို့မဟုတ် လိုဂိုများကို အသုံးပြုခြင်းသည် အဆိုပါ အဖွဲ့အစည်းများ၏ မူဝါဒများကို လိုက်နာရမည်ဖြစ်သည်။
