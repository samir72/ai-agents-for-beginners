...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-03T14:37:58+00:00",
...
Eğer takılırsanız veya AI Ajanları oluşturma hakkında sorularınız varsa, [Azure AI Foundry Community Discord](https://aka.ms/ai-agents/discord) üzerindeki özel Discord kanalımıza katılabilirsiniz.
...
| AI Agentleri için Bağlam Mühendisliği            | [Bağlantı](./12-context-engineering/README.md)         | [Video](https://youtu.be/F5zqRV7gEag)                                 | [Bağlantı](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
- [GitHub Copilot ile AI Eşli Programlama Ustalığı](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
