...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T21:20:16+00:00",
...
## Курс, който учи всичко необходимо за създаване на AI агенти
...
Този курс включва уроци, които обхващат основите на създаването на AI агенти. Всеки урок разглежда отделна тема, така че можете да започнете оттам, където ви е удобно!
...
Не забравяйте да [отбележите (🌟) този репозиторий](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) и [разклонете този репозиторий](https://github.com/microsoft/ai-agents-for-beginners/fork), за да изпълните кода.

### Запознайте се с други обучаващи се, задавайте въпроси

Ако срещнете затруднения или имате въпроси относно създаването на AI агенти, присъединете се към нашия специален Discord канал в [Azure AI Foundry Community Discord](https://aka.ms/ai-agents/discord).
...
Този курс също използва следните AI агентни рамки и услуги от Microsoft:
...
| Изследване на AI агентни рамки               | [Линк](./02-explore-agentic-frameworks/README.md)| [Видео](https://youtu.be/ODwF-EZo_O8?si=Vawth4hzVaHv-u0H)  | [Линк](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Разбиране на AI агентни дизайнерски модели   | [Линк](./03-agentic-design-patterns/README.md)   | [Видео](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)  | [Линк](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Дизайнерски модел за използване на инструменти| [Линк](./04-tool-use/README.md)                  | [Видео](https://youtu.be/vieRiPRx-gI?si=2z6O2Xu2cu_Jz46N)  | [Линк](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Създаване на надеждни AI агенти              | [Линк](./06-building-trustworthy-agents/README.md)| [Видео](https://youtu.be/iZKkMEGBCUQ?si=jZjpiMnGFOE9L8OK ) | [Линк](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Дизайнерски модел за планиране               | [Линк](./07-planning-design/README.md)           | [Видео](https://youtu.be/kPfJ2BrBCMY?si=6SC_iv_E5-mzucnC)  | [Линк](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Дизайнерски модел за много агенти            | [Линк](./08-multi-agent/README.md)               | [Видео](https://youtu.be/V6HpE9hZEx0?si=rMgDhEu7wXo2uo6g)  | [Линк](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Дизайнерски модел за метакогниция            | [Линк](./09-metacognition/README.md)             | [Видео](https://youtu.be/His9R6gw6Ec?si=8gck6vvdSNCt6OcF)  | [Линк](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Управление на агентска памет                 | [Връзка](./13-agent-memory/README.md)     |                                                            |                                                                                        |
...
- [**НОВ** Edge AI за начинаещи](https://github.com/microsoft/edgeai-for-beginners?WT.mc_id=academic-105485-koreyst)
...
Този проект може да съдържа търговски марки или лога за проекти, продукти или услуги. Употребата на търговски марки или лога на Microsoft е предмет на и трябва да следва
