...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-03T15:14:58+00:00",
...
Šiam kursui yra daugiakalbė parama. Eikite į mūsų [galimas kalbas čia](../..). 
...
- [Modelio konteksto protokolas (MCP) pradedantiesiems](https://github.com/microsoft/mcp-for-beginners?WT.mc_id=academic-105485-koreyst)
...
Indėlio licencijos sutartimi (CLA), patvirtinančia, kad turite teisę ir iš tikrųjų suteikiate mums
...
CLA ir atitinkamai pažymės PR (pvz., statuso patikrinimas, komentaras). Tiesiog sekite boto pateiktas instrukcijas.
