...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-03T14:59:29+00:00",
...
## Egy kurzus, amely mindent megtanít, amit tudnod kell az AI ügynökök építésének elkezdéséhez
...
Ez a kurzus az AI ügynökök építésének alapjait tárgyaló leckéket tartalmaz. Minden lecke egy-egy különálló témát ölel fel, így bármelyik ponton elkezdheted!

A kurzus többnyelvű támogatással rendelkezik. Az elérhető nyelvek listáját [itt találod](../..). 

Ha ez az első alkalom, hogy generatív AI modellekkel dolgozol, nézd meg a [Generatív AI kezdőknek](https://aka.ms/genai-beginners) kurzusunkat, amely 21 leckét tartalmaz a GenAI-val való munkáról.
...
A kurzus minden leckéje tartalmaz kódpéldákat, amelyeket a code_samples mappában találhatsz. [Forkold ezt a repót](https://github.com/microsoft/ai-agents-for-beginners/fork), hogy saját példányt hozz létre.  

Az ezekben a gyakorlatokban található kódpéldák az Azure AI Foundry-t és a GitHub Model Catalogs-t használják a nyelvi modellekkel való interakcióhoz:
...
Ez a kurzus a Microsoft alábbi AI ügynök keretrendszereit és szolgáltatásait is használja:
...
Van javaslatod, vagy találtál helyesírási vagy kódhibát? [Jelentsd be a problémát](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) vagy [Hozz létre egy pull requestet](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)



## 📂 Minden lecke tartalmazza

- Egy írásos leckét a README-ben és egy rövid videót
- Python kódpéldákat, amelyek támogatják az Azure AI Foundry-t és a Github Modelleket (Ingyenes)
- Linkeket további tananyagokhoz, hogy folytathasd a tanulást


## 🗃️ Leckék

| **Lecke**                                   | **Szöveg & Kód**                                  | **Videó**                                                  | **További tananyagok**                                                                |
|---------------------------------------------|---------------------------------------------------|------------------------------------------------------------|---------------------------------------------------------------------------------------|
| Bevezetés az AI ügynökökbe és felhasználási területeikbe | [Link](./01-intro-to-ai-agents/README.md)          | [Videó](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
Ez a projekt örömmel fogadja a hozzájárulásokat és javaslatokat. A legtöbb hozzájárulás megköveteli, hogy elfogadj egy
