...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-02T08:05:23+00:00",
...
## Kurz, ktorý vás naučí všetko potrebné na vytváranie AI agentov
...
Tento kurz obsahuje lekcie pokrývajúce základy tvorby AI agentov. Každá lekcia sa venuje samostatnej téme, takže môžete začať kdekoľvek!
...
Ak sa zaseknete alebo máte otázky o tvorbe AI agentov, pripojte sa na náš dedikovaný Discord kanál v [Azure AI Foundry Community Discord](https://aka.ms/ai-agents/discord).
...
Máte návrhy alebo ste našli chyby v texte či kóde? [Nahláste problém](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) alebo [vytvorte pull request](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst).
...
| Tvorba agentov na používanie počítača (CUA)          | Pripravujeme                            |                                                            |                                                                                        |
| Nasadzovanie škálovateľných agentov                  | Pripravujeme                            |                                                            |                                                                                        |
| Tvorba lokálnych AI agentov                          | Pripravujeme                               |                                                            |                                                                                        |
| Zabezpečenie AI agentov                              | Pripravujeme                               |                                                            |                                                                                        |
...
Keď odošlete pull request, CLA bot automaticky určí, či musíte poskytnúť CLA, a označí PR primerane (napr. kontrola stavu, komentár). Jednoducho postupujte podľa pokynov poskytovaných botom. Toto budete musieť urobiť iba raz vo všetkých repozitároch používajúcich našu CLA.
